...
$options[] = array(	'type' => 'maintabletop');
	...
	$options[] = array(	'name' => __('General Settings', 'bizzthemes'),
		...
		$options[] = array(	'name' => __('Logo Image &amp; Favicon', 'bizzthemes'),
							'toggle' => 'true',
							'type' => 'subheadingtop');
		...
		$options[] = array(	'name' => __('Image Lightbox', 'bizzthemes'),
							'toggle' => 'true',
							'type' => 'subheadingtop');			
					
			if ($bizz_package != 'ZnJlZQ=='){
			
			$options[] = array(	'name' => __('Image Lighbox Effect', 'bizzthemes'),
								'desc' => __('If you want your photos or any other links to pop up with lightbox effect, check this option. To learn more, please <a href="'.esc_url('fancybox.net/howto').'">visit this site</a>.', 'bizzthemes'),
								'label' => __('Enable image lightbox script', 'bizzthemes'),
	...
	$options[] = array(	'name' => __('Framework Branding', 'bizzthemes'),
		...
		$options[] = array(	'name' => __('Theme Name', 'bizzthemes'),
			...
			$options[] = array(	'name' => __('Your Icon', 'bizzthemes'),
								'desc' => __('Upload your image or paste the full URL address to it next to upload button. Choose small image (16x16 px limits). <span class="important">Your upload will start after you save changes</span>', 'bizzthemes'),
		...
		$options[] = array(	'name' => __('Hide Update Notifications', 'bizzthemes'),
							'toggle' => 'true',
							'type' => 'subheadingtop');
							
			if ($bizz_package != 'ZnJlZQ==' && $bizz_package != 'c3RhbmRhcmQ='){
								
			$options[] = array(	'name' => __('Hide WordPress Update Notifications', 'bizzthemes'),
								'desc' => __('Hide sll WordPress update notifications and stop them from nagging your clients.', 'bizzthemes'),
								'label' => __('Hide All WordPress Update Notifications', 'bizzthemes'),
...
$options[] = array(	'type' => 'maintabletop');
	...
	$options[] = array(	'name' => __('Complete SEO Control', 'bizzthemes'),
		...
		$options[] = array(	'name' => __('Head <code>&lt;title&gt;</code> tags', 'bizzthemes'),
			...
			$options[] = array(	'name' => __('Site name in Title?', 'bizzthemes'),
			...
			$options[] = array(	'name' => __('Tagline in Title?', 'bizzthemes'),
			...
			$options[] = array(	'name' => __('Site name in Title across All Pages?', 'bizzthemes'),
								'label' => __('Add site name to all other page titles.', 'bizzthemes'),
								'desc' => __('Add site name in title across all pages. Example: About|Sitename', 'bizzthemes'),
		...
		$options[] = array(	'name' => __('Head <code>&lt;meta&gt;</code> tags', 'bizzthemes'),
			...
			$options[] = array(	'name' => __('Meta Keywords (comma separated)', 'bizzthemes'),
								'desc' => __('Meta keywords are rarely used nowadays but you can still provide search engines with additional information about topics that appear on your site. This only applies to your home page.', 'bizzthemes'),
			...
			$options[] = array(	'name' => __('Meta Author', 'bizzthemes'),
								'desc' => __('You should write your <em>full name</em> here but only do so if this blog is writen only by one outhor. This only applies to your home page.', 'bizzthemes'),
...
function bizz_seo_metaboxes( $meta_boxes ) {
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array(
				'name' => __('SEO Meta Keywords', 'bizzthemes'),
				'desc' => __('Enter a few keywords for this post/page, separate them by comma (,).', 'bizzthemes'),
				'id' => $prefix . 'keywords',
				'type' => 'text'
			),
			array(
