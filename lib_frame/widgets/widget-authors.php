...
class Bizz_Widget_Authors extends WP_Widget {
	...
	function Bizz_Widget_Authors() {
		...
		$control_ops = array( 'width' => 525, 'height' => 350, 'id_base' => "widgets-reloaded-bizz-authors" );
		$this->WP_Widget( "widgets-reloaded-bizz-authors", __( 'Authors', 'bizzthemes' ), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			...
			<select class="widefat" id="<?php echo $this->get_field_id( 'style' ); ?>" name="<?php echo $this->get_field_name( 'style' ); ?>">
				<?php foreach ( array( 'list' => __( 'List', 'bizzthemes'), 'none' => __( 'None', 'bizzthemes' ) ) as $option_value => $option_label ) { ?>
		...
		<p>
			...
			<input class="checkbox" type="checkbox" <?php checked( $instance['html'], true ); ?> id="<?php echo $this->get_field_id( 'html' ); ?>" name="<?php echo $this->get_field_name( 'html' ); ?>" /> <?php _e( '<acronym title="Hypertext Markup Language">HTML</acronym>?', 'bizzthemes' ); ?></label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'optioncount' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['optioncount'], true ); ?> id="<?php echo $this->get_field_id( 'optioncount' ); ?>" name="<?php echo $this->get_field_name( 'optioncount' ); ?>" /> <?php _e( 'Show post count?', 'bizzthemes' ); ?></label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'exclude_admin' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['exclude_admin'], true ); ?> id="<?php echo $this->get_field_id( 'exclude_admin' ); ?>" name="<?php echo $this->get_field_name( 'exclude_admin' ); ?>" /> <?php _e( 'Exclude admin?', 'bizzthemes' ); ?></label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'show_fullname' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['show_fullname'], true ); ?> id="<?php echo $this->get_field_id( 'show_fullname' ); ?>" name="<?php echo $this->get_field_name( 'show_fullname' ); ?>" /> <?php _e( 'Show full name?', 'bizzthemes' ); ?></label>
		</p>
		<p>
