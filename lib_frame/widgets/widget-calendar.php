...
class Bizz_Widget_Calendar extends WP_Widget {
	...
	function Bizz_Widget_Calendar() {
		$widget_ops = array( 'classname' => 'calendar', 'description' => __( 'Control the output of your calendar.', 'bizzthemes' ) );
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => "widgets-reloaded-bizz-calendar" );
		$this->WP_Widget( "widgets-reloaded-bizz-calendar", __( 'Calendar', 'bizzthemes' ), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'initial' ); ?>"><?php _e( 'One-letter abbreviation?', 'bizzthemes' ); ?> <code>initial</code></label>
		</p>
		</div>
	<?php
	}
