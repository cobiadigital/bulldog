...
class Bizz_Widget_Categories extends WP_Widget {
	...
	function Bizz_Widget_Categories() {
		$widget_ops = array( 'classname' => 'categories', 'description' => __( 'Control the output of your category links.', 'bizzthemes' ) );
		$control_ops = array( 'width' => 550, 'height' => 350, 'id_base' => "widgets-reloaded-bizz-categories" );
		$this->WP_Widget( "widgets-reloaded-bizz-categories", __( 'Categories', 'bizzthemes' ), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		// Defaults
		$defaults = array(
			'title' => __( 'Categories', 'bizzthemes' ),
			'taxonomy' => 'category',
			'depth' => '',
			'number' => '',
			'exclude_tree' => '',
		...
		$style = array( 'list' => __( 'List', 'bizzthemes' ), 'none' => __( 'None', 'bizzthemes' ) );
		...
		$feed_type = array( '' => '', 'atom' => __( 'Atom', 'bizzthemes' ), 'rdf' => __( 'RDF', 'bizzthemes' ), 'rss' => __( 'RSS', 'bizzthemes' ), 'rss2' => __( 'RSS 2.0', 'bizzthemes' ) );
		...
		<p>
			...
			<input class="checkbox" type="checkbox" <?php checked( $instance['hierarchical'], true ); ?> id="<?php echo $this->get_field_id( 'hierarchical' ); ?>" name="<?php echo $this->get_field_name( 'hierarchical' ); ?>" /> <?php _e( 'Hierarchical?', 'bizzthemes' ); ?></label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'use_desc_for_title' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['use_desc_for_title'], true ); ?> id="<?php echo $this->get_field_id( 'use_desc_for_title' ); ?>" name="<?php echo $this->get_field_name( 'use_desc_for_title' ); ?>" /> <?php _e( 'Use description?', 'bizzthemes' ); ?></label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'show_last_update' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['show_last_update'], true ); ?> id="<?php echo $this->get_field_id( 'show_last_update' ); ?>" name="<?php echo $this->get_field_name( 'show_last_update' ); ?>" /> <?php _e( 'Show last update?', 'bizzthemes' ); ?></label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'show_count' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['show_count'], true ); ?> id="<?php echo $this->get_field_id( 'show_count' ); ?>" name="<?php echo $this->get_field_name( 'show_count' ); ?>" /> <?php _e( 'Show count?', 'bizzthemes' ); ?></label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'hide_empty' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['hide_empty'], true ); ?> id="<?php echo $this->get_field_id( 'hide_empty' ); ?>" name="<?php echo $this->get_field_name( 'hide_empty' ); ?>" /> <?php _e( 'Hide empty?', 'bizzthemes' ); ?></label>
		</p>
		</div>
