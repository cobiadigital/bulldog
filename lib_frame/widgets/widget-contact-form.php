...
class Bizz_Widget_Contact extends WP_Widget {
	...
	function Bizz_Widget_Contact() {		
		...
		$control_ops = array( 'width' => 350, 'height' => 350, 'id_base' => "widgets-reloaded-bizz-c-form" );
		$this->WP_Widget( "widgets-reloaded-bizz-c-form", __( 'Contact Form', 'bizzthemes' ), $widget_ops, $control_ops );
	}
