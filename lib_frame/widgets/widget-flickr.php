...
class Bizz_Widget_Flickr extends WP_Widget {
	...
	function Bizz_Widget_Flickr() {
		$widget_ops = array( 'classname' => 'flickr', 'description' => __( 'Flickr widget displays your flickr photos.', 'bizzthemes' ) );
		$control_ops = array( 'width' => 350, 'height' => 350, 'id_base' => "widgets-reloaded-bizz-flickr" );
		$this->WP_Widget( "widgets-reloaded-bizz-flickr", __( 'Flickr Photos', 'bizzthemes' ), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
        ...
        <p>
            ...
            <select name="<?php echo $this->get_field_name('flickr_type'); ?>" class="widefat" id="<?php echo $this->get_field_id('flickr_type'); ?>">
                <option value="user" <?php if($instance['flickr_type'] == "user"){ echo "selected='selected'";} ?>><?php _e('User', 'bizzthemes'); ?></option>
                <option value="group" <?php if($instance['flickr_type'] == "group"){ echo "selected='selected'";} ?>><?php _e('Group', 'bizzthemes'); ?></option>            
            </select>
        </p>
        <p>
            ...
            <select name="<?php echo $this->get_field_name('flickr_sorting'); ?>" class="widefat" id="<?php echo $this->get_field_id('flickr_sorting'); ?>">
                <option value="latest" <?php if($instance['flickr_sorting'] == "latest"){ echo "selected='selected'";} ?>><?php _e('Latest', 'bizzthemes'); ?></option>
                <option value="random" <?php if($instance['flickr_sorting'] == "random"){ echo "selected='selected'";} ?>><?php _e('Random', 'bizzthemes'); ?></option>            
            </select>
        </p>
