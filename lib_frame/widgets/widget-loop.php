...
class Bizz_Widget_Loop extends WP_Widget {
	...
	function Bizz_Widget_Loop() {
		$widget_ops = array( 'classname' => 'loop', 'description' => __( 'Loop widget displays your posts loop for current page or archive.', 'bizzthemes' ) );
		$control_ops = array( 'width' => 550, 'height' => 350, 'id_base' => "widgets-reloaded-bizz-loop" );
		$this->WP_Widget( "widgets-reloaded-bizz-loop", __( 'WordPress Loop', 'bizzthemes' ), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			...
			<input class="checkbox" type="checkbox" <?php checked( $instance['ajax_pagination'], true ); ?> id="<?php echo $this->get_field_id( 'ajax_pagination' ); ?>" name="<?php echo $this->get_field_name( 'ajax_pagination' ); ?>" /> <?php _e( 'Ajax pagination', 'bizzthemes'); ?></label>
		</p>
		<small class="section">Thumbnail Options</small>
		<p>
			<label for="<?php echo $this->get_field_id( 'thumb_display' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['thumb_display'], true ); ?> id="<?php echo $this->get_field_id( 'thumb_display' ); ?>" name="<?php echo $this->get_field_name( 'thumb_display' ); ?>" /> <?php _e( 'Display Thumbnail Images on Index pages', 'bizzthemes'); ?></label><br/>
			<label for="<?php echo $this->get_field_id( 'thumb_single' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['thumb_single'], true ); ?> id="<?php echo $this->get_field_id( 'thumb_single' ); ?>" name="<?php echo $this->get_field_name( 'thumb_single' ); ?>" /> <?php _e( 'Display Thumbnail Images on Single Posts', 'bizzthemes'); ?></label><br/>
			<label for="<?php echo $this->get_field_id( 'thumb_selflink' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['thumb_selflink'], true ); ?> id="<?php echo $this->get_field_id( 'thumb_selflink' ); ?>" name="<?php echo $this->get_field_name( 'thumb_selflink' ); ?>" /> <?php _e( 'Link thumbnail to itself?', 'bizzthemes'); ?></label>
		</p>
		<p>
