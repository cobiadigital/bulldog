...
class Bizz_Widget_Pages extends WP_Widget {
	...
	function Bizz_Widget_Pages() {
		$widget_ops = array( 'classname' => 'pages', 'description' => __( 'Control the output of your page links.', 'bizzthemes') );
		$control_ops = array( 'width' => 550, 'height' => 350, 'id_base' => "widgets-reloaded-bizz-pages" );
		$this->WP_Widget( "widgets-reloaded-bizz-pages", __( 'Pages', 'bizzthemes'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$sort_order = array( 'ASC' => __( 'Ascending', 'bizzthemes' ), 'DESC' => __( 'Descending', 'bizzthemes' ) );
		$sort_column = array( 'post_author' => __( 'Author', 'bizzthemes' ), 'post_date' => __( 'Date', 'bizzthemes' ), 'ID' => __( 'ID', 'bizzthemes' ), 'menu_order' => __( 'Menu Order', 'bizzthemes' ), 'post_modified' => __( 'Modified', 'bizzthemes' ), 'post_name' => __( 'Slug', 'bizzthemes' ), 'post_title' => __( 'Title', 'bizzthemes' ) );
		$show_date = array( '' => '', 'created' => __( 'Created', 'bizzthemes' ), 'modified' => __( 'Modified', 'bizzthemes' ) );
