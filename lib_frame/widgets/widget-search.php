...
class Bizz_Widget_Search extends WP_Widget {
	...
	function Bizz_Widget_Search() {
		...
		$control_ops = array( 'width' => 350, 'height' => 350, 'id_base' => "widgets-reloaded-bizz-search" );
		$this->WP_Widget( "widgets-reloaded-bizz-search", __( 'Search', 'bizzthemes' ), $widget_ops, $control_ops );
	}
