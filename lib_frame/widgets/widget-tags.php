...
class Bizz_Widget_Tags extends WP_Widget {
	...
	function Bizz_Widget_Tags() {
		...
		$this->WP_Widget( "widgets-reloaded-bizz-tags", __( 'Tags', 'bizzthemes' ), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$link = array( 'view' => __( 'View', 'bizzthemes' ), 'edit' => __( 'Edit', 'bizzthemes' ) );
		$format = array( 'flat' => __( 'Flat', 'bizzthemes' ), 'list' => __( 'List', 'bizzthemes' ) );
		$order = array( 'ASC' => __( 'Ascending', 'bizzthemes' ), 'DESC' => __( 'Descending', 'bizzthemes' ), 'RAND' => __( 'Random', 'bizzthemes' ) );
		$orderby = array( 'count' => __( 'Count', 'bizzthemes' ), 'name' => __( 'Name', 'bizzthemes' ) );
		...
		<p>
			...
			<input class="checkbox" type="checkbox" <?php checked( $instance['pad_counts'], true ); ?> id="<?php echo $this->get_field_id( 'pad_counts' ); ?>" name="<?php echo $this->get_field_name( 'pad_counts' ); ?>" /> <?php _e( 'Pad counts?', 'bizzthemes' ); ?></label>
		</p>
		<p>
