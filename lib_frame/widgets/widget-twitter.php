...
if (!class_exists('Wickett_Twitter_Widget')) {
	...
	class Wickett_Twitter_Widget extends WP_Widget {
		...
		function Wickett_Twitter_Widget() {
			...
			$control_ops = array( 'width' => 350, 'height' => 350, 'id_base' => "{$this->prefix}-branding" );
			$this->WP_Widget('twitter', __('Twitter Updates', 'bizzthemes'), $widget_ops);
		}
		...
		function widget( $args, $instance ) {
			...
			if ( empty($title) ) $title = __( 'Twitter Updates', 'bizzthemes' );
		...
		function form( $instance ) {
			...
			//Defaults
			$defaults = array(
				'title' => __( 'Twitter Updates', 'bizzthemes' ),
				'account' => 'BizzThemes',
				'show' => '3',
				'hidereplies' => false,
				'beforetimesince' => '',
